...
@section('contenido')
    <div class="row">
        ...
        <h3>Editar Articulo:  {{$articulo->nombre}}</h3>
            ...
            {{Form::open(array('action'=>array('ArticuloController@update',$articulo->idarticulo),'method'=>'patch','files'=>'true'))}}
            {{Form::token()}}
    <div class="row">
    ...
    @if (($articulo->imagen)!="")
        <img src="{{asset('imagenes/articulos/'.$articulo->imagen)}}" height="50%" width="50%">
    @endif  
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
        <div class="form-group">
